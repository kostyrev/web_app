...
# Add a database user.
mysql_database_user node['web_app']['database']['app']['username'] do
  connection(
    :host => node['web_app']['database']['host'],
    :username => node['web_app']['database']['username'],
    :password => root_password_data_bag_item['password']
...
cookbook_file node['web_app']['database']['seed_file'] do
...
execute 'initialize database' do
  command "mysql -h #{node['web_app']['database']['host']} -u #{node['web_app']['database']['app']['username']} -p#{user_password_data_bag_item['password']} -D #{node['web_app']['database']['dbname']} < #{node['web_app']['database']['seed_file']}"
  not_if  "mysql -h #{node['web_app']['database']['host']} -u #{node['web_app']['database']['app']['username']} -p#{user_password_data_bag_item['password']} -D #{node['web_app']['database']['dbname']} -e 'describe customers;'"
end
